...
{
    public class CorsEndpointRoutingTests : CorsTestsBase<CorsWebSite.StartupWith21Compat>
    {
        public CorsEndpointRoutingTests(MvcTestFixture<CorsWebSite.StartupWith21Compat> fixture)
            : base(fixture)
        {
        }
